    ...
    <div class="row">
        <div class="col-md-6">
            <div class="input-group">
                <input type="text" class="form-control" placeholder="请输入员工姓名进行搜素..." id="search_input">
        ...
        <div class="col-md-4 col-md-offset-9">
            ...
            <button class="btn btn-danger" id="emp_delete_batch_btn">批量删除</button>
        </div>
    </div>
    <%--显示表格数据--%>
    <div class="row">
...
<script type="text/javascript">
    ...
    //1.页面加载完成以后，直接发送一个ajax请求，得到分页数据
    $(function(){
        //默认在首页
        to_page(1);
    });
    ...
    function build_page_info(result) {
        ...
        $("#page_info_area").append("当前"+result.extend.pageInfo.pageNum+"页，" +
            "总共"+result.extend.pageInfo.pages+"页，总" +
    ...
    function validate_add_form(){
        ...
        if(!regName.test(empName)){
            show_validate_msg("#empName_add_input","error","用户名可以是2-5位中文或者6-16位的英文与数字的组合");
            return false;
        }else{
    ...
    $("#check_all").click(function () {
        ...
        //prop修改和读取dom原生属性的值，attr获取自定义属性的值
        $(".check_item").prop("checked",$(this).prop("checked"));
    });

    $(document).on("click",".check_item",function () {
        //判断当前选中的元素是否为五个
        var flag = $(".check_all:checked").length == $(".check_item").length;
